...
# Interactive loop with better formatting
print(f"\n{'='*70}")
print("🎭 STRANGER THINGS COMPLAINT DEPARTMENT (LANGGRAPH EDITION) 🎭")
print(f"{'='*70}")
print("\n📋 FILE A COMPLAINT about Hawkins, the Upside Down, or its creatures!")
print("   The AI will AUTOMATICALLY use the right tools to handle your complaint.")
print("   Complex complaints will use MULTIPLE tools.")
...
while True:
    ...
    if user_input.lower() == 'exit':
        print("\n👋 Complaint department closing. The Upside Down will return to chaos as usual.")
        break
    
    print("\n" + "-"*70)
    print("⚙️ PROCESSING COMPLAINT...")
    print("-"*70)
    ...
    if final_response:
        print(f"\n{'='*70}")
        print("📝 OFFICIAL COMPLAINT RESPONSE")
        print(f"{'='*70}\n")
        print(final_response)
        print("\n" + "="*70)
    else:
        print("\n⚠️ No final response generated. Try again.")